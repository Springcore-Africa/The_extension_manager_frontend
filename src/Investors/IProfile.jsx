...
const IProfile = () => {
  ...
  const [investor, setInvestor] = useState({
    firstname: "Olakunle",
    lastname: "Taoreed",
    email: "olakunle@example.com",
    phone: "+234 800 000 0000",
    location: "Lagos, Nigeria",
    about:
      "I am a passionate investor focused on supporting innovative and sustainable agricultural projects. I believe in empowering local farmers and boosting food production across the nation through smart, impactful investments.",
  });
  ...
  const handleChange = (e) => {
    ...
    setInvestor((prev) => ({ ...prev, [name]: value }));
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    setShowSuccess(true);
    setIsReadOnly(true); // Set form to read-only after save
  };
  ...
  return (
    <>
      <div className="flex min-h-screen bg-green-50">
        <InvestorAsideBar />
        <main className="flex-1 p-6 md:p-10 bg-green-50">
